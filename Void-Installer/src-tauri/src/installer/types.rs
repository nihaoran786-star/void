...
pub struct InstallOptions {
    ...
    /// First-launch theme preference (`system` or Void built-in theme id)
...
impl From<void_ai_adapters::types::RemoteModelInfo> for RemoteModelInfo {
    fn from(value: void_ai_adapters::types::RemoteModelInfo) -> Self {
        Self {
            id: value.id,
...
impl From<void_ai_adapters::types::ConnectionTestMessageCode> for ConnectionTestMessageCode {
    fn from(value: void_ai_adapters::types::ConnectionTestMessageCode) -> Self {
        match value {
            void_ai_adapters::types::ConnectionTestMessageCode::ToolCallsNotDetected => {
                Self::ToolCallsNotDetected
            }
            void_ai_adapters::types::ConnectionTestMessageCode::ImageInputCheckFailed => {
...
impl From<void_ai_adapters::types::ConnectionTestResult> for ConnectionTestResult {
    fn from(value: void_ai_adapters::types::ConnectionTestResult) -> Self {
        Self {
