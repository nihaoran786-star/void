...
/** Same rule as main app `getSystemPreferredDefaultThemeId`: dark -> void-dark, else void-light. */
export function getSystemPreferredBuiltinThemeId(): ThemeId {
  if (typeof window === 'undefined' || typeof window.matchMedia !== 'function') {
    return 'void-light';
  }
  return window.matchMedia('(prefers-color-scheme: dark)').matches ? 'void-dark' : 'void-light';
}
 ...
 * When preference is `system`, follows `prefers-color-scheme` like the main void ThemeService.
 */
