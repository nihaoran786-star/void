...
What this is: how locale contracts and translation resources are owned and
loaded per surface. Read it before adding a locale, a namespace, or a new
translated surface; see the development guide for the day-to-day steps.

void uses one locale contract across all product surfaces, but each surface owns
...
- Installer: `Void-Installer/src/i18n/locales/*.json`
