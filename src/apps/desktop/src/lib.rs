...
pub async fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::agentic_api::update_session_goal,
            ...
            api::agent_revision_api::publish_agent_revision,
            api::agent_revision_api::set_agent_default_revision,
            api::team_definition_api::list_team_definitions,
            api::team_definition_api::get_team_definition,
            api::team_definition_api::create_team_definition,
            ...
            theme::show_team_workspace_desktop_window,
            theme::hide_team_workspace_desktop_window,
            theme::reveal_team_workspace_desktop_window,
            theme::is_team_workspace_desktop_window_open,
...
async fn init_agentic_system() -> anyhow::Result<(
    ...
    let goal_token_usage_subscriber = Arc::new(
        void_core::agentic::goal_mode::GoalTokenUsageSubscriber::new(session_manager.clone()),
    );
    event_router.subscribe_internal("goal_token_usage".to_string(), goal_token_usage_subscriber);
