...
const I18N = {
  'en-US': {
    ...
    publishedItemLocked: 'Published review items cannot be deleted from void.',
    owner: 'Owner',
    repo: 'Repository',
    ...
    publishConfirmBody: 'These comments will be posted to the provider. This action cannot be undone from void.',
    ...
    statusPartialSync: 'Refreshed what void could access. {count} source could not be refreshed.',
    ...
    reviewingBannerBody: 'void is reading the diff and preparing editable findings. You can keep browsing the PR or stop this run.',
    ...
    lifecycleUnsupported: 'This provider does not support this action from void.',
    ...
    lifecycleGuideHead: 'Refresh the PR so void can verify the latest head commit.',
    ...
    lifecycleAutoAuthHint: 'void will try to authorize with GitHub CLI before this action.',
    ...
    lifecycleConfirmMergeBody: 'This will merge the selected PR on the provider. void will use the expected head SHA shown below.',
  ...
  'zh-CN': {
    ...
    publishedItemLocked: '已发布的 Review 项不能在 void 中删除。',
    owner: 'Owner',
    repo: '仓库',
    providerName: '显示名称',
    kind: '类型',
    ...
    publishConfirmBody: '这些评论会提交到代码平台。void 无法替你撤回这个操作。',
    ...
    statusPartialSync: '已刷新 void 可访问的内容。{count} 个来源暂时无法刷新。',
    ...
    reviewingBannerBody: 'void 正在读取 diff 并整理可编辑问题。你可以继续浏览 PR，也可以中止本次审核。',
    cancelReview: '中止审核',
    ...
    lifecycleUnsupported: '当前代码平台不支持在 void 中执行这个操作。',
    ...
    lifecycleGuideHead: '刷新 PR，让 void 确认最新 head 提交。',
    ...
    lifecycleAutoAuthHint: 'void 会先尝试通过 GitHub CLI 自动授权。',
    ...
    lifecycleConfirmMergeBody: '这会在代码平台合并当前选中的 PR。void 会使用下方显示的预期 head SHA。',
  ...
  'zh-TW': {
    ...
    publishedItemLocked: '已發布的 Review 項不能在 void 中刪除。',
    owner: 'Owner',
    repo: '倉庫',
    providerName: '顯示名稱',
    kind: '類型',
    ...
    publishConfirmBody: '這些評論會提交到程式碼平台。void 無法替你撤回這個操作。',
    ...
    statusPartialSync: '已重新整理 void 可存取的內容。{count} 個來源暫時無法重新整理。',
    ...
    reviewingBannerBody: 'void 正在讀取 diff 並整理可編輯問題。你可以繼續瀏覽 PR，也可以中止本次審核。',
    cancelReview: '中止審核',
    ...
    lifecycleUnsupported: '目前程式碼平台不支援在 void 中執行此操作。',
    ...
    lifecycleGuideHead: '重新整理 PR，讓 void 確認最新 head 提交。',
    ...
    lifecycleAutoAuthHint: 'void 會先嘗試透過 GitHub CLI 自動授權。',
    ...
    lifecycleConfirmMergeBody: '這會在程式碼平台合併目前選中的 PR。void 會使用下方顯示的預期 head SHA。',
...
function providerHeaders(profile, jsonBody = false) {
  const headers = {
    ...
    'User-Agent': 'void-PR-Review-MiniApp',
  };
  ...
  return `
    <form class="pr-form pr-form--compact" id="subscription-form">
      ...
      <label class="pr-field">
        ...
        <input class="pr-input" name="owner" placeholder="void" required />
      </label>
      <label class="pr-field">
        <span>${esc(t('repo'))}</span>
        <input class="pr-input" name="repo" placeholder="void" required />
      </label>
