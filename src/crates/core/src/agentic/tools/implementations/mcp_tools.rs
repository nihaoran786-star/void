...
fn tool_error(message: impl Into<String>) -> VoidError {
    VoidError::tool(message.into())
}
...
async fn get_mcp_server_manager() -> VoidResult<Arc<MCPServerManager>> {
