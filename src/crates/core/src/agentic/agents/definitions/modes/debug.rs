...
impl DebugMode {
    ...
    fn load_reminder_template(&self, template_name: &str) -> VoidResult<String> {
        get_embedded_prompt(template_name)
            .map(str::to_string)
            .ok_or_else(|| {
                crate::util::errors::VoidError::Agent(format!(
...
"#,
    ...
    fn build_ongoing_reminder(&self) -> VoidResult<String> {
