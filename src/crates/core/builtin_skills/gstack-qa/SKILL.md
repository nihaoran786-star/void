...
When this skill is invoked by Void Team Mode, this skill supplies the QA methodology. Use existing Task sub-agents for independent testing tracks, then keep triage and fix ownership explicit in the main Team session.
...
| Mode | full | `--regression .void/team/qa-reports/baseline.json` |
...
```bash
mkdir -p .void/team/qa-reports/screenshots
```
...
Void browser/computer-use screenshot "$REPORT_DIR/screenshots/issue-NNN-after.png"
Void browser/computer-use console --errors
Void browser/computer-use snapshot -D
```
...
- Include full attribution comment:
  ...
  // Report: .void/team/qa-reports/qa-report-{domain}-{date}.md
  ```
