                  ...
                  <span className="void-func-agent-config__pet-expand-current">
                    <span className="void-func-agent-config__pet-select-thumb" aria-hidden>
                      {selectedCompanionPetPackage ? (
                        ...
                        <ChatInputPixelPet mood="rest" pet={selectedCompanionPet} className="void-func-agent-config__pet-select-preview" />
                      )}
                    </span>
                              ...
                              <span className="void-func-agent-config__pet-select-thumb" aria-hidden>
                                {pet ? (
                                  ...
                                  <ChatInputPixelPet
                                    ...
                                    className="void-func-agent-config__pet-select-preview"
                                  />
                                )}
                              </span>
