...
export class AppManager implements IAppManager {
  ...
  private clearPersistedPanelState(): void {
    try {
      ...
      localStorage.removeItem('void-app-state');
      
      // Clear other potential panel state keys
      localStorage.removeItem('void-left-panel-width');
      localStorage.removeItem('void-left-panel-collapsed');
      localStorage.removeItem('void-right-panel-collapsed');
