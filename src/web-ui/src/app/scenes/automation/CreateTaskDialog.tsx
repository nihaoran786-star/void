...
const SCHEDULE_OPTIONS: ScheduleOption[] = [
  { value: 'once', labelKey: 'create.schedule.once.label', hintKey: 'create.schedule.once.hint', icon: Zap },
  { value: 'hourly', labelKey: 'create.schedule.hourly.label', hintKey: 'create.schedule.hourly.hint', icon: Repeat },
  { value: 'daily', labelKey: 'create.schedule.daily.label', hintKey: 'create.schedule.daily.hint', icon: CalendarClock },
];
...
const EXECUTION_MODE_OPTIONS: Array<{ value: AutomationExecutionMode; labelKey: string; hintKey: string }> = [
  { value: 'code', labelKey: 'create.executionMode.code.label', hintKey: 'create.executionMode.code.hint' },
  { value: 'cowork', labelKey: 'create.executionMode.cowork.label', hintKey: 'create.executionMode.cowork.hint' },
];
    ...
    >
      ...
      >
        <div className="create-task-dialog__head">
          <h3 className="create-task-dialog__title">{t('create.title')}</h3>
          <button
            type="button"
        ...
        <div className="create-task-dialog__body">
          ...
          <div className="create-task-dialog__field">
            <label className="create-task-dialog__label">{t('create.fields.workspace')}</label>
            <select
            ...
            {hasNoWorkspace && onOpenWorkspace && (
              ...
              >
                {t('create.workspace.open')}
              </button>
            )}
          </div>

          <div className="create-task-dialog__field">
            <label className="create-task-dialog__label">{t('create.fields.executionMode')}</label>
            <div
              className="create-task-dialog__mode-slider"
              role="tablist"
              aria-label={t('create.fields.executionMode')}
            >
            ...
            <p className="create-task-dialog__hint">
              {t(EXECUTION_MODE_OPTIONS.find(option => option.value === executionMode)?.hintKey ?? 'create.executionMode.code.hint')}
            </p>
          </div>
          ...
          <div className="create-task-dialog__field">
            <label className="create-task-dialog__label">{t('create.fields.schedule')}</label>
          ...
          <div className="create-task-dialog__field">
            <label className="create-task-dialog__label">{t('create.fields.priority')}</label>
            ...
            <div className="create-task-dialog__row">
              <div className="create-task-dialog__field create-task-dialog__field--grow2">
                <label
                  ...
                  className="create-task-dialog__label"
                >
                  {scheduleType === 'once' ? t('create.fields.runDate') : t('create.fields.startDate')}
                </label>
                <input
                  id="task-date"
                  type="date"
