...
const literalMonoBaseline: Record<string, number> = {
  ...
  'flow_chat/components/usage/SessionUsageReportCard.scss': 1,
  ...
  it('keeps remaining non-DOM debt and font-engine exceptions on exact baselines', () => {
    ...
    expectExactBaseline(
      countByDeclaration(literalMono),
      {
        ...
        "flow_chat/components/usage/SessionUsageReportCard.scss [css]: 'SF Mono', 'Monaco', 'Cascadia Code', monospace": 1,
