              ...
              <Tooltip content={workspace.rootPath} placement="right" followCursor>
                ...
                >
                  <span className="void-nav-panel__workspace-item-name-line">
                    ...
                    {relatedPathCount > 0 ? (
                      <span className="void-nav-panel__workspace-item-badge">
            ...
            {menuOpen && menuPosition && createPortal(
              ...
              >
                ...
                {acpClientsLoading ? (
                  ...
                  >
                    <Loader2 size={13} />
                    <span className="void-nav-panel__workspace-item-menu-label">{t('app.loading')}</span>
                  </button>
                ) : null}
                ...
                >
                  <Archive size={13} />
                  <span className="void-nav-panel__workspace-item-menu-label">{t('nav.sessions.archiveAll')}</span>
                </button>
