...
const RELAY_SERVER_README_URL = 'https://github.com/void/void/blob/main/src/apps/relay-server/README.md';
const FEISHU_SETUP_GUIDE_URLS = {
  'zh-CN': 'https://github.com/void/void/blob/main/docs/remote-connect/feishu-bot-setup.zh-CN.md',
  'en-US': 'https://github.com/void/void/blob/main/docs/remote-connect/feishu-bot-setup.md',
