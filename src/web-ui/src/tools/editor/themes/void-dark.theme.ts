 ...
 */
export const VoidDarkTheme: editor.IStandaloneThemeData = {
  base: 'vs-dark',
  inherit: true,
...
export const VoidDarkThemeMetadata = {
  id: 'void-dark',
  label: 'Dark',
