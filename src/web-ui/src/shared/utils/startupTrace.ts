...
export function installStartupTraceDiagnostics(trace: StartupTrace = startupTrace): void {
  globalThis.__VOID_STARTUP_TRACE__ = {
    snapshot: () => trace.snapshot(),
    flushSummary: reason => trace.flushSummary(reason),
  };
}
