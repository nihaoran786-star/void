/**
 * Undo / redo for the Infinite Canvas (P4 W5, plan §2.4).
 *
 ...
 *
 * The keyboard half of undo — which key means undo, and which targets own
 * their own undo stack — stayed in the panel's folder, because that is a
 * statement about a browser and not about a document.
 */
import type {
