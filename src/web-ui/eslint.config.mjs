...
export default tseslint.config(
  ...
  {
    // Descending ladder, not a permanent ceiling. 3050 clears the largest
    // panel today (InfiniteCanvasPanel.tsx, 3019 lines) by one notch. Each
    ...
    rules: {
      'max-lines': ['warn', { max: 3050, skipBlankLines: false, skipComments: false }],
    },
  },
  {
